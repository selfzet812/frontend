...
export default function Register() {
  ...
  return (
    <div
      className="min-h-screen grid-bg flex items-center justify-center px-5"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md page-enter">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-bold text-slate-100">Create an account</h1>
          <p className="text-slate-400 mt-1.5 text-sm">Start capturing your ideas today</p>
        </div>
