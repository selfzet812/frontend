      ...
      <div className="max-w-7xl mx-auto">
        <div className="glass rounded-2xl px-5 py-3 flex items-center justify-between"
          ...
          <div className="flex items-center gap-2">
            {isAuth ? (
              <>
                <span className="hidden sm:block text-xs text-slate-500 max-w-[140px] truncate">{email}</span>
                ...
                <button onClick={logout} className="btn-secondary text-xs py-2 px-3" title="Sign out">
